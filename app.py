...
app.config['MAIL_USERNAME'] = 'dhanrajgangrade750@gmail.com'
app.config['MAIL_PASSWORD'] = 'vejisgkebrcyhsru'
        ...
        if request.method == 'POST':
            ...
            if algo == 'aes':
                ...
                msg = Message(
                    ...
                    sender='dhanrajgangrade750@gmail.com',
...
def imgintoimg():
    ...
    if 'loggedin' in session:
        ...
        # User is logged show them the home page
